...
const baseDeDatos = [
    ...
    {
        id: 3,
        nombre: 'Buscando Alaska',
        precio: 2100,
        imagen: './Imagenes/Buscando a Alaska.jpg'
    },
    {
        id: 4,
...
DOMbotonConfirmar.addEventListener ('click', () => {

    Swal.fire({
        position: 'top-center',
        icon: 'success',
        title: 'Pedido Confirmado. Complete el formulario de contacto',
